...
// Derive thumbnail path from full-res photo path:
// "/event-photos/foo.webp" → "/event-photos/thumbs/foo.webp"
// Pre-generated by scripts/gen-thumbs.mjs (232px wide, ~6 KB each).
      ...
      <div className="gallery">
        ...
        <div className="gallery-thumbs" ref={thumbsRef}>
          {slides.map((src, i) => (
            ...
            >
              {/* Thumb-версия из /event-photos/thumbs/ (232px wide webp,
                  ~6 KB). Раньше src указывал на full-res (1920px, ~150 KB
                  каждое × 21 = ~3 MB), Lighthouse это ловил как
                  «image-delivery savings». loading="lazy" + intersection
                  decode по-прежнему дают batching по viewport'у. */}
